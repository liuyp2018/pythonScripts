...
class BrushTicket(object):
    ...
    def __init__(self, user_name, password, passengers, from_time, from_station, to_station, number, seat_type, receiver_mobile, receiver_email):
        ...
        self.executable_path = 'D:\\Python36\chromedriver.exe'
...
class Buy_Tickets(object):
    # 定义实例属性，初始化
    def __init__(self, username, passwd, order, passengers, dtime, starts, ends,receiver_mobile,receiver_email):
        self.username = username
        self.passwd = passwd
        # 车次，0代表所有车次，依次从上到下，1代表第1个车次，依次类推
        self.order = order
        # 乘客名
        self.passengers = passengers
        # 起始地和终点
                ...
                while self.driver.url == self.ticket_url:
                    ...
                    try:
                        ...
                        try:
                            ...
                            #alert.accept()
                            self.driver.find_by_xpath("//span[text()='温馨提示']/../..//a[text()='确定']").click()
                            sleep(1)
                        except:
                            pass
...
if __name__ == '__main__':
    ...
    Buy_Tickets(user_name, password, order, passengers, from_time, from_station, to_station,receiver_mobile,receiver_email).start_buy()