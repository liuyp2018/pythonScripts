...
#jenkins项目目录
JENKINS_PATH='C:/Users/EDZ/.jenkins/workspace/wdove_42_admin_incremDeploy'
#待增量复制的文件所在目录
copyFileCommonPath='C:/Users/EDZ/.jenkins/workspace/wdove_42_admin_incremDeploy/copyFiles'
#存放svn中更改文件的文件路径
changedFile='D:/Apache-Subversion-1.10.0/bin/adminchangedfiles.txt'
#在操作前，将上一次生成的待复制文件删除
